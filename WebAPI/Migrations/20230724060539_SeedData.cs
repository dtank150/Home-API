    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                insert into Users(Username,Password, PasswordKey)
                select 'Demo',
                ...
                Insert into Cities(Name,LastUpdatedBy,LastUpdateOn,Country)
                ...
                insert into Properties(SellRent,Name,PropertyTypeId,BHK,FurnishingTypeId,Price,BuiltArea,CarprtArea,Address,
                Address2,CityId,FloorNo,TotalFloors,ReadyToMove,MianEntrance,Security,Gated,Maintenance,EstPossessionOn,Age,Description,PostedOn,PostedBy,LastUpdateOn,LastUpdatedBy)
                select 
                1, --Sell Rent
